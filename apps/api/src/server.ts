...
app.get('/api/health', (req,res)=>res.json({status:'healthy',service:'Smart Forensic API',mode:'adb-first',version:'1.2.0',timestamp:new Date().toISOString()}));
app.get('/', (req,res)=>res.json({name:'Smart Android Forensic & Security Analysis API',status:'online',mode:'adb-first',adbStatusEndpoint:'/api/adb/status',agentEndpoint:'/api/agent/status',documentation:'/docs'}));
